...
from app.web.api.utils.models import StatusTypes, BaseModel
...
class UserContextTenant(SQLModel):
    id: uuid.UUID
    name: str


class UserContextTeam(SQLModel):
    id: uuid.UUID
    name: str
    tenant_id: uuid.UUID
...
class UserContext(SQLModel):
    user: UserOut
    tenants: list[UserContextTenant]
    teams: list[UserContextTeam]
