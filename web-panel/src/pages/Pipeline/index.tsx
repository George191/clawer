...
const  DataLayersWorkspace:  React.FC  =  ()  =>  {
    ...
    const  activateTool  =  (tool:  'sql'  |  'filter'  |  'partition'  |  'script'  |  'analysis'  |  'api')  =>  {
        const  next  =  (tool  ===  'sql'  &&  !sqlOpen)  ||  (tool  ===  'filter'  &&  !filterOpen)  ||  (tool  ===  'partition'  &&  !partitionOpen)  ||  (tool  ===  'script'  &&  !scriptOpen)  ||  (tool  ===  'analysis'  &&  !analysisOpen)  ||  (tool  ===  'api'  &&  !apiOpen);
        setSqlOpen(next  &&  tool  ===  'sql');  setFilterOpen(next  &&  tool  ===  'filter');  setPartitionOpen(next  &&  tool  ===  'partition');  setScriptOpen(next  &&  tool  ===  'script');  setAnalysisOpen(next  &&  tool  ===  'analysis');  setApiOpen(next  &&  tool  ===  'api');
    };
                ...
                {createOpen  ?  <div  className="flow-inspector  flow-inline-designer-v2">
                    ...
                    <div  className="flow-inspector-body">
                        <div  className="flow-navicat-toolbar">
                                    <span  className={`flow-tool  ${sqlOpen  ?  'is-active'  :  ''}`}  onClick={()  =>  activateTool('sql')}><CodeOutlined  />SQL  console</span>
                                    <span  className={`flow-tool  ${filterOpen  ?  'is-active'  :  ''}`}  onClick={()  =>  activateTool('filter')}>Filter</span>
                                    <span  className={`flow-tool  ${partitionOpen  ?  'is-active'  :  ''}`}  onClick={()  =>  activateTool('partition')}>Partitions</span>
                                    <span  className={`flow-tool  ${scriptOpen  ?  'is-active'  :  ''}`}  onClick={()  =>  activateTool('script')}>Layer  script</span>
                                    <span  className={`flow-tool  ${analysisOpen  ?  'is-active'  :  ''}`}  onClick={()  =>  activateTool('analysis')}>Analysis</span>
                                    <span  className={`flow-tool  ${apiOpen  ?  'is-active'  :  ''}`}  onClick={()  =>  activateTool('api')}>Data  API</span>
